...
public class BrowseHandler {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BrowseHandler.checkBrowse(ie9));
        System.out.println(BrowseHandler.checkBrowse(ie8));
        System.out.println(BrowseHandler.checkBrowse(ie7));
        System.out.println(BrowseHandler.checkBrowse(ie6));
        System.out.println(BrowseHandler.checkBrowse(aoyou));
        System.out.println(BrowseHandler.checkBrowse(qq));
        System.out.println(BrowseHandler.checkBrowse(green));
        System.out.println(BrowseHandler.checkBrowse(se360));
        System.out.println(BrowseHandler.checkBrowse(chrome));
        System.out.println(BrowseHandler.checkBrowse(safari));
        System.out.println(BrowseHandler.checkBrowse(fireFox));
        System.out.println(BrowseHandler.checkBrowse(opera));
        System.out.println(BrowseHandler.checkBrowse(other));
    }
